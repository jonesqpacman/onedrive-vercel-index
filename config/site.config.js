...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'jonesqpacman@driveku.org',
  ...
  title: "PacManPjkt™ OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/Publik',
  ...
  email: 'mailto:jonesqpacman@protonmail.com',
